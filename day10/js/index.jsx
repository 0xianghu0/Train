...
const Header = (props) => {
    ...
    return (<div>
        <Container>
            <Nav className="justify-content-center" style={{ border: 'none' }} variant="tabs" defaultActiveKey="All" onSelect={(selectedKey) => props.onClick(selectedKey)} >
...
const RepoCard = (props) => (<Card border="primary" style={{ marginTop: '8px', marginBottom: '8px' }}>
    <Card.Header className="text-center bg-dark font-weight-bold">{props.no}</Card.Header>
    <Card.Body className="bg-dark">
        ...
        <ListGroup className="list-group-flush">
            <ListGroupItem className="bg-light">
                <Card.Text><i className="fa fa-user fa-lg fa-fw" style={{ color: 'black' }}></i>{props.author}</Card.Text>
            </ListGroupItem>
            <ListGroupItem className="bg-light">
                <Card.Text><i className="fa fa-star fa-lg fa-fw" style={{ color: 'black' }}></i>{props.stars}</Card.Text>
            </ListGroupItem>
            <ListGroupItem className="bg-light">
                <Card.Text><i className="fa fa-code-fork fa-lg fa-fw" style={{ color: 'black' }}></i>{props.forks}</Card.Text>
            </ListGroupItem>
            <ListGroupItem className="bg-light">
                <Card.Text><i className="fa fa-warning fa-lg fa-fw" style={{ color: 'black' }}></i>{props.issues}</Card.Text>
            </ListGroupItem>
        </ListGroup>
    </Card.Body>
</Card>)
    ...
    render() {
        ...
        return (<div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
            <div className="container">
                ...
                <Footer>
                    <div className="text-center text-light jumbotron bg-dark">
                        <h5>LZY</h5>
                    </div>
                </Footer>
            </div>
